...
def main():
    ...
    parser = argparse.ArgumentParser(description="convert darknet to onnx")
    parser.add_argument("cfg_file_path", help="darknet config file")
    parser.add_argument("weights_file_path", help="darknet weights file")
